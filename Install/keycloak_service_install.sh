...
echo "-------------------------------------------------------------------"
echo " "
echo " - Pour afficher les logs du server keycloak                       "
echo "     $ sudo tail -f /opt/keycloak/standalone/log/server.log        "
echo "     $ journalctl -u keycloak.service                              "
echo "                                                                   "  
echo " - Pour afficher l'etat du service keycloak :                      "
echo "     $ sudo systemctl status keycloak.service                      "
echo ""
echo " - Tester l'acces a la console keycloak :                          "
echo "      http://localhost:8080/auth/                                  "
echo ""
echo " - Tester l'acces a la console wildfly  :                          "
